<nav class="navbar navbar-vertical navbar-expand-xl navbar-light navbar-vibrant">
    <div class="d-flex align-items-center">
        ...
        <a class="navbar-brand" href="<?php echo site_url('admin2053/dashboard') ?>">
                ...
                <div class="navbar-vertical-divider">
                    ...
                    <ul class="navbar-nav flex-column">
                        <?php if (session()->get('admin_role') == 'superadmin') { ?>
                            <li class="nav-item<?php if (current_url() === site_url('admin2053/admin')) { ?> active<?php } ?>">
                                <a class="nav-link" href="<?= site_url('admin2053/admin') ?>">
                                    <div class="d-flex align-items-center">
